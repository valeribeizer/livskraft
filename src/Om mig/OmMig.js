          ...
          <div className="row">
            <div className="col-12 col-lg-8">
              <p className="p-om">
                ...
                vi påverka den genom våra val, ibland är sjukdom bortom vår
                kontroll. Men oavsett var vi börjar finns det alltid utrymme för
                läkning, balans och förståelse.
                <br />
                <br />
                Jag heter Eunice och är legitimerad apotekare med en
                masterexamen i farmaci. Under mina två år på apotek mötte jag
                många människor med långa medicinlistor och små, men viktiga,
                frågor. Jag såg hur vården ofta saknade tid för det viktigaste –
                samtalet. Där föddes idén till Livskraft.
                <br />
                <br />
                ...
                att se hela människan och inte bara symtomen.
                <br />
                <br />
                Som mamma till en tvååring vet jag hur viktigt det är att hitta
                balans i livet och skapa utrymme för det som verkligen betyder
                något. Den energin vill jag dela med dig här på Livskraft. Min
                vision är att hjälpa dig hitta din väg till färre läkemedel, mer
                välmående och en hälsa som håller – för livet.
                <br />
                <br />
            ...
            <div className="col-12 col-lg-4 col-om-mig">
                <img className="om-mig-img" src="blog-img-3.png" alt="om-mig-img" loading="lazy" />
            </div>
          </div>
        </div>
        <Footer />
